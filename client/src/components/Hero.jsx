...
const Hero = () => {
  ...
  const handleSubmit = async () => {
    ...
    if (!addressTo || !amount || !keyword || !message) return alert("Please fill in all fields.");
    ...
    <div className="flex w-full justify-center items-center">
      <div className="flex md:flex-row gap-16 flex-col items-start justify-between md:p-20 py-12 px-4">
        ...
        <div className="flex flex-1 justify-start items-start flex-col md:mr-10">
          ...
          >
            <span className="absolute w-0 h-0 transition-all duration-500 ease-out bg-[#2952e3] rounded-full group-hover:w-56 group-hover:h-56"></span>
